...
const OPTIONAL = [
    ...
    { key: 'TWILIO_API_KEY_SECRET', desc: 'Twilio API Key Secret (alternative to auth token for webhook validation)' },
    { key: 'TWILIO_VALIDATE_REQUESTS', default: 'false', desc: 'Enable Twilio webhook signature validation (set true in production)' },
    ...
    { key: 'VAPI_WEBHOOK_SECRET', desc: 'Vapi webhook shared secret for verifying webhook authenticity' },
