                  ...
                  {template.variables.map(variable => (
                    <div key={variable} className="flex items-center gap-3">
                      ...
                      <input
                        ...
                        className="flex-1 px-3 py-1.5 bg-bg-secondary border border-border rounded-lg text-sm text-white placeholder:text-text-muted focus:outline-none focus:border-border-hover"
                      />
                    </div>
                  ))}
                </div>
