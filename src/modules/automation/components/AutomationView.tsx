...
export function AutomationView() {
    ...
    return (
        <div className="space-y-6">
            {/* ============================================================
                PAGE HEADER — Premium gradient header with live stats
               ============================================================ */}
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-accent-primary/10 via-bg-secondary to-accent-info/10 border border-border p-6">
                ...
                <div className="absolute bottom-0 left-0 w-48 h-48 bg-accent-info/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/4 pointer-events-none" />

                <div className="relative flex items-start justify-between gap-4">
                    <div className="flex items-center gap-4">
                        <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-accent-primary/15 border border-accent-primary/20">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-text-muted mt-0.5">
                                Scrape leads, automate outreach, and track campaign performance
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 flex-shrink-0">
                        <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-bg-tertiary/50 border border-border text-xs">
