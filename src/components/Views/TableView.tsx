...
import { Video, Smartphone, MessageSquare, Youtube, FileText, FileCode, Link2, LucideIcon } from 'lucide-react'
...
export const TableView = memo(function TableView({ contents, onEdit, onUpdateStatus, onOpenDetail }: TableViewProps) {
...
const TableRow = memo(function TableRow({ content, isSelected, onToggleSelect, onUpdateStatus, onOpenDetail }: { content: Content, isSelected: boolean, onToggleSelect: () => void, onUpdateStatus?: (id: string, status: string) => void, onOpenDetail?: (content: Content) => void }) {
