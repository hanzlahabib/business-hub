...
import { ChevronDown, ChevronUp, Filter, Video, Smartphone, Calendar, MessageSquare, Youtube, FileText, FileCode, Link2, ExternalLink, ArrowUpDown, CheckSquare, Briefcase, Users, Target, LucideIcon } from 'lucide-react'
...
interface ListViewProps {
    contents: Content[]
    items?: any[]
    calendarFilters?: { contents: boolean; tasks: boolean; jobs: boolean; leads: boolean; milestones: boolean }
...
export const ListView = memo(function ListView({
    ...
    const SortHeader = useCallback(({ field, children }: { field: string, children: React.ReactNode }) => (
        <button
...
const ListRow = memo(function ListRow({ content, onEdit, onOpenDetail }: { content: Content, onEdit?: (content: Content) => void, onOpenDetail?: (content: Content) => void }) {
...
const CalendarItemRow = memo(function CalendarItemRow({ item, onClick }: { item: any, onClick?: (item: any) => void }) {
