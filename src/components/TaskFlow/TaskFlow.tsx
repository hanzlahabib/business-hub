...
import {
    Lightbulb, FileText, Video, Scissors, Image, CheckCircle, X, LucideIcon
} from 'lucide-react'
...
export const TaskFlow = memo(function TaskFlow({
    ...
    const stats = useMemo(() => {
        ...
        const published = stageCounts.published || 0
            ...
            <div className="flex items-center gap-6">
                ...
                `}
                                style={{
                                    ...
                                    // ringColor: isActive ? stage.color : 'transparent' // style prop doesn't accept ringColor, removed it
                                }}
                            >
                                <div
