...
import { Monitor, Pencil, User, FileText, Check, ChevronDown } from 'lucide-react'
...
function VariantGuideModal({ isOpen, onClose, selectedVariant = null }) {
  const variantKeys = selectedVariant ? [selectedVariant] : Object.keys(VARIANT_GUIDES)
  const [openVariant, setOpenVariant] = useState(selectedVariant || variantKeys[0])
...
export default memo(VariantGuideModal)
