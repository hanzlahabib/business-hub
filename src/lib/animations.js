...
export const presentationReveal = (index, delay = 1.5) => ({
...
export const presentationRevealUp = (index, delay = 1.5) => ({
...
export const flowNodeReveal = (index) => ({
